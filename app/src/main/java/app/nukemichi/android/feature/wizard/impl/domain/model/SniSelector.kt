...
internal object SniSelector {
    // A masking domain hosted in the same jurisdiction as the network being routed around defeats
    // the point: the traffic reads as ordinary domestic traffic, which is exactly what gets inspected.
